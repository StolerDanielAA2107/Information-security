...
// LR2Stoler.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLR2StolerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CLR2StolerApp

CLR2StolerApp::CLR2StolerApp()
{
...
// Единственный объект CLR2StolerApp

CLR2StolerApp theApp;


// Инициализация CLR2StolerApp

BOOL CLR2StolerApp::InitInstance()
{
